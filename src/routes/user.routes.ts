...
router.get('/', authMiddleware, libraryMiddleware, UserController.getAllMembers);
router.post('/add', authMiddleware, libraryMiddleware, UserController.addMember);
...
router.get('/:id/history', authMiddleware, libraryMiddleware, UserController.getMemberBorrowHistory);
